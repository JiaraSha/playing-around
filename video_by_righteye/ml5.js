...
let rightEye, circleMask, angleOnCircle, myAvatarObj;
...
function setup() {
    ...
    rightEye = { "x": myVideo.width / 2, "y": myVideo.height / 2 };
...
function gotPoses(results) {
    ...
    poses = results;
    progress = "predicting";
    let thisEye = results[0].pose.rightEye;
    ...
    if (thisEye.confidence > .8) {
      rightEye.x = thisEye.x;
      rightEye.y = thisEye.y;
...
function draw() {
    ...
    circleMask.ellipse(rightEye.x, rightEye.y, 60, 60)//use nose pos to draw alpha
